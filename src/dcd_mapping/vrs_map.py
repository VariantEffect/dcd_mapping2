...
def vrs_map(
    ...
    :param scores: scoreset records
    :param align_result: output from the sequence alignment process
    :param transcript: output of transcript selection process. For regulatory/noncoding
        scoresets, this value should be ``None``.
    ...
    return _map_regulatory_noncoding(
        metadata=metadata, records=scores, align_result=align_result, sr=sr
    )
